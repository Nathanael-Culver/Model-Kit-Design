...
| SRC-P009 | User-supplied wireless-power module photographs, 2026-09-07 | Exact wireless pair physically identified: **TX1 is the green XKT-412 transmitter board** with visible `IN+`/`IN-` supply end and `OUT` coil end; **RX1 is the larger receiver board whose IC marking clearly reads `XKT-3168`**, with flat spiral receive coil and factory red/black DC output leads. Output voltage/current/polarity remain meter-verified before connection. |
